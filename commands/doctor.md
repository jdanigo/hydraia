...
1. Run `"${CLAUDE_PLUGIN_ROOT}/hooks/doctor.sh" --check` and show me the full output. It also reports this repo's resolved storage (artifacts base, in-repo vs external, and the auto-commit setting) under `-- storage --`.
